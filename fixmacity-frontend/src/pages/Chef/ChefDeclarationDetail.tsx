          ...
          <table className="w-full min-w-[800px]">
            <thead className="bg-slate-50 dark:bg-slate-900 sticky top-0 z-10">
              <tr className="text-[10px] font-black text-slate-500 uppercase tracking-widest border-b border-slate-100 dark:border-slate-800">
                ...
                {visibleCols.priority && <th className="px-4 py-3 text-left cursor-pointer" onClick={() => toggleSort('priority_score')}><div className="flex items-center gap-1">Priorité <Brain size={10} className="text-violet-500" /><SortIcon col="priority_score" sort={sort} /></div></th>}
