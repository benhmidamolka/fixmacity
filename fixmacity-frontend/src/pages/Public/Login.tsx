      ...
      <div className="flex-1 flex flex-col justify-between px-8 sm:px-14 py-10 bg-white overflow-y-auto">
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="flex justify-center">
            {/* Google */}
            <button type="button" className="flex items-center gap-3 px-6 py-3 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors text-sm font-semibold text-slate-600">
